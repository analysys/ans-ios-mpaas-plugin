...
- (void)viewDidLoad {
    ...
    self.scriptMessage = [[WeakScriptMessageDelegate alloc] initWithDelegate:self];
...
//    NSURL *filePath = [NSURL URLWithString:[NSString stringWithFormat:@"http://192.168.5.128/openSource-JS/demo/ios.html?t=%f",[[NSDate date] timeIntervalSince1970]]];
    NSURL *filePath = [NSURL URLWithString:@"http://uc.analysys.cn/huaxiang/4.5.1/index.html"];
