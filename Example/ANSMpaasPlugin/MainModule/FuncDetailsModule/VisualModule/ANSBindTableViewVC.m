...
//    [bindTableView registerNib:[UINib nibWithNibName:@"ANSBindTableViewCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:@"ANSBindTableViewCell"];
    [bindTableView registerClass:[ANSBindTableViewCellTMP class] forCellReuseIdentifier:@"ANSBindTableViewCellTMP"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ANSBindTableViewCellTMP *cell = [tableView dequeueReusableCellWithIdentifier:@"ANSBindTableViewCellTMP" forIndexPath:indexPath];
//    cell.ans_titleLab.text = [NSString stringWithFormat:@"section:%ld-row:%ld", indexPath.section, indexPath.row];
    cell.lab.text = [NSString stringWithFormat:@"section:%ld-row:%ld", indexPath.section, indexPath.row];
